...
class World extends JComponent {
    ...
    private TextLayout t1, t2, t3, t4, t5; /* Text layouts */
	...
	if(isGameOver) {	    
	    ...
	    t5=  new TextLayout("You are going to get Chicken party :)",f2,frc);
	    t3 = new TextLayout("Try Again", f2, frc);
	    t4 = new TextLayout("Get Some Help With Ij...", f2, frc);	
	    t1.draw(g2, 300, 270);
	    if(score == 15) {
...
g2.setColor(Color.red);
	...
	g2.drawString("Ijhar Ansari", 360, 560);
